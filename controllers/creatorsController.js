...
//     })
//   );
router.get("/supportCreators", function(req, res) {
  // replace old function with sequelize function
  db.Creator.findAll()
    // use promise method to pass the burgers...
    .then(function(response) {
      // into the main index, updating the page
      var hbsObject = { creator: response, jsFile: "supportCreators" };
      return res.render("supportCreators", hbsObject);
    });
});
...
// router.get("/admin/creators", function(req, res) {
